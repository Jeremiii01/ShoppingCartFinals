...
<div class="d-flex align-items-center my-5">
        <div class="card mx-auto shadow-lg" style="width: 330px; border-radius: 10px;">
            <div class="card-header">
                ...
                <form method="post" action="include/account-inc.php">               
                    <input type="password" name="currentPass" class="form-control mb-3" placeholder="Current Password" required />
                    <input type="password" name="newPass" class="form-control mb-3" placeholder="New Password" required />
                    <input type="password" name="confirmNewPass" class="form-control mb-3" placeholder="Confirm New Password" required />
                    <button class="btn btn-secondary btn-signin mb-5 w-100" name="submitBTN" type="submit">Submit</button>
                </form>
            </div>
        </div>
    </div>
